# Author: Myrl Marmarelis <myrl@marmarel.is>
...
from . import barnes_hut  # type: ignore


MACHINE_EPSILON = np.finfo(np.double).eps


def _joint_probabilities(deformation, distances, desired_perplexity, verbose):
    ...
    conditional_P = utils._binary_search_perplexity(
        deformation, distances, desired_perplexity, verbose)
...
def _joint_probabilities_nn(deformation, distances, desired_perplexity, verbose):
    ...
    conditional_P = utils._binary_search_perplexity(
        deformation, distances_data, desired_perplexity, verbose)
...
def _kl_divergence_bh(params, P, degrees_of_freedom, n_samples, n_components,
    ...
    error = barnes_hut.gradient(val_P, X_embedded, neighbors, indptr,
...
class TSNE(BaseEstimator):
    ...
    def __init__(self, n_components=2, *, perplexity=30.0,
                 ...
                 n_jobs=None, square_distances='legacy', deformation=1.0):
    ...
    def _fit(self, X, skip_num_points=0):
        ...
        if self.method == "exact":
            ...
            P = _joint_probabilities(
                self.deformation, distances, self.perplexity, self.verbose)
            ...
            P = _joint_probabilities_nn(
                self.deformation, distances_nn, self.perplexity, self.verbose)
